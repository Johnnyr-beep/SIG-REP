...
def _sembrar_movimientos(sesion: Session) -> None:
    ...
    filas = [
        ...
        MovimientoContable(
            cia=4, co="402", periodo=PERIODO, auxiliar="1105", mayor_iii="1105",
            descripcion="CAJA", saldo_inicial=Decimal("0"), debitos=Decimal("100.00"),
            creditos=Decimal("0"), final=Decimal("100.00"),
        ),
        MovimientoContable(
            cia=4, co="402", periodo=PERIODO, auxiliar="1305010101", mayor_iii="1305",
            descripcion="CLIENTES", id_tercero="900111", razon_social="CLIENTE UNO",
            saldo_inicial=Decimal("0"), debitos=Decimal("200.00"), creditos=Decimal("0"),
            final=Decimal("200.00"),
        ),
        MovimientoContable(
            cia=4, co="402", periodo=PERIODO, auxiliar="1520", mayor_iii="1520",
            descripcion="MAQUINARIA", saldo_inicial=Decimal("0"), debitos=Decimal("300.00"),
            creditos=Decimal("0"), final=Decimal("300.00"),
        ),
        # Pasivo corriente 150 (naturaleza crédito: FINAL crudo -150.00)
        MovimientoContable(
            cia=4, co="402", periodo=PERIODO, auxiliar="2205", mayor_iii="2205",
            descripcion="PROVEEDORES", saldo_inicial=Decimal("0"), debitos=Decimal("0"),
            creditos=Decimal("150.00"), final=Decimal("-150.00"),
        ),
        # Patrimonio 350 (naturaleza credito: FINAL crudo -350.00)
        MovimientoContable(
            cia=4, co="402", periodo=PERIODO, auxiliar="3705", mayor_iii="3705",
            descripcion="UTILIDADES ACUMULADAS", saldo_inicial=Decimal("0"),
            debitos=Decimal("0"), creditos=Decimal("350.00"), final=Decimal("-350.00"),
        ),
        # Ingreso 500 (naturaleza credito: FINAL crudo -500.00)
        MovimientoContable(
            cia=4, co="402", periodo=PERIODO, auxiliar="4135", mayor_iii="4135",
            descripcion="VENTA", saldo_inicial=Decimal("0"), debitos=Decimal("0"),
            creditos=Decimal("500.00"), final=Decimal("-500.00"),
        ),
        # Costo de venta 200 y gasto 100 (naturaleza debito: FINAL positivo)
        MovimientoContable(
            cia=4, co="402", periodo=PERIODO, auxiliar="6135", mayor_iii="6135",
            descripcion="COSTO VENTA", saldo_inicial=Decimal("0"), debitos=Decimal("200.00"),
            creditos=Decimal("0"), final=Decimal("200.00"),
        ),
        MovimientoContable(
            cia=4, co="402", periodo=PERIODO, auxiliar="5105", mayor_iii="5105",
            descripcion="SUELDO", saldo_inicial=Decimal("0"), debitos=Decimal("100.00"),
            creditos=Decimal("0"), final=Decimal("100.00"),
        ),
    ]
