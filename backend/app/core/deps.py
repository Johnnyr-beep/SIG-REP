...
PERMISO_CONSULTAR_FINANCIERO = "PERMISO_CONSULTAR_FINANCIERO"
...
PERMISO_DESCARGAR_VENTA_DIARIA_ASADERO = "PERMISO_DESCARGAR_VENTA_DIARIA_ASADERO"
...
PERMISO_COSTO_POR_PRODUCTO = "PERMISO_COSTO_POR_PRODUCTO"
...
PERMISOS_CONSULTA: dict[str, str] = {
    ...
    PERMISO_CONSULTAR_FINANCIERO: "Consultar tablero financiero consolidado",
...
_UNIDADES: frozenset[str] = frozenset({"carnes", "agropecuaria", "carnes-frias", "grupo-santacruz"})
